...
**To import and configure the shell in CloudShell:**
  ...
  *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers*
  ...
  4. Import the new data model.
      ...
      2. Select the *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers\cloudshell-L1-mrv\datamodel\mrv_ResourceConfiguration.xml* file.
      3. Click **Open**.
...
The *install_driver.bat* script creates a virtual environment on the Quali Server machine under *C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers\cloudshell-L1-mrv* and installs the required dependencies in this virtual environment from the extracted L1 shell folder (under *~cloudshell-L1-mrv\packages*).
...
5. Copy the upgraded shell's datamodel file from:
	...
	*C:\Program Files (x86)\QualiSystems\CloudShell\Server\Drivers\cloudshell-L1-mrv\datamodel\mrv_ResourceConfiguration.xml*
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/cloudshell-L1-mrv/releases).
